...
class RoPEAttention(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        with torch.nn.attention.sdpa_kernel(torch.nn.attention.SDPBackend.FLASH_ATTENTION), torch.amp.autocast('cuda',enabled=True,dtype=torch.bfloat16):
...
class DiT(torch.nn.Module):
    ...
    Args:
        ...
        conditionC (int): Number of conditioning channels
    ...
    """
    def __init__(self,channels,nBlocks,inC,outC,conditionC,nHeads=8,patchSize=1):
        super().__init__()
